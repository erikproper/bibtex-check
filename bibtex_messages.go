...
const (
	...
	WarningEntryAliasesLineTooShort   = "Line in entry field aliases file is too short: %s"
	WarningGenericAliasesLineTooShort = "Line in generic field aliases file is too short: %s"
	...
	ProgressWritingGenericAliasesFile      = "Writing generic field aliases file %s"
	ProgressWritingEntryAliasesFile        = "Writing entry field aliases file %s"
	...
	ProgressReadingGenericAliasesFile      = "Reading generic field aliases file %s" // Really all these variations?
	ProgressReadingEntryAliasesFile        = "Reading entry field aliases file %s"
