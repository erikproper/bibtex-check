...
const (
	...
	WarningAmbiguousJournalAlias                     = "Ambiguous journal alias: for %s we have %s and %s."
	...
	WarningAliasIsOriginal                           = "Alias %s is already known to be an original."
	WarningOriginalIsAlias                           = "Alias %s has a an original %s, which is actually an alias for %s."
	...
	ProgressCheckingConsistencyOfPreferredKeyAliases = "Checking consistency and completeness of preferred key aliases."
	ProgressCheckingConsistencyOfKeyAliases          = "Checking consistency and completeness of key aliases."
	ProgressCheckingConsistencyOfNameAliases         = "Checking consistency and completeness of name aliases."
	ProgressCheckingConsistencyOfJournalAliases      = "Checking consistency and completeness of journal aliases."
	ProgressCheckingConsistencyOfSchoolAliases       = "Checking consistency and completeness of school aliases."
	ProgressCheckingConsistencyOfInstitutionAliases  = "Checking consistency and completeness of institution aliases."
	ProgressCheckingConsistencyOfOrganisationAliases = "Checking consistency and completeness of organisation aliases."
	ProgressCheckingConsistencyOfSeriesAliases       = "Checking consistency and completeness of series aliases."
	ProgressCheckingConsistencyOfPublisherAliases    = "Checking consistency and completeness of publisher aliases."
